...
namespace Main
{
    public partial class Hospital_Info_Save_Form : Form
    {
        ...
        private void complete_btn_Click(object sender, EventArgs e)
        {
            ...
            DB.set_hospital_info(PK, hospitalName, hospitalPhone, doctorNum, signficant, hospitalDiff);
            DB.set_location_info(PK, first, second, detailed);
            
            MessageBox.Show("병원 등록이 완료되었습니다!");
